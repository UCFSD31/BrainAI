...
def draw_specific_landmarks(image, landmarks, indices, mp_draw):
    for idx in indices:
    ...
    while cap.isOpened():
        ...
        if hand_results.multi_hand_landmarks:
            for hand_landmark in hand_results.multi_hand_landmarks:
                ...
                draw_specific_landmarks(image, hand_landmark.landmark, thumb_indices, mp_draw)
                draw_specific_landmarks(image, hand_landmark.landmark, middle_finger_indices, mp_draw)
                draw_specific_landmarks(image, hand_landmark.landmark, index_finger_indices, mp_draw)
